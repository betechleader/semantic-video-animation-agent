...
import type {AnimationOverlayProps, KeywordPopProps, QuoteCardProps} from './types';
...
const quoteDefaults: QuoteCardProps = {headline: 'Key takeaway', body: 'Structured output makes video planning reliable.', accent_color: '#6EE7B7', start_ms: 2500, end_ms: 4000};
